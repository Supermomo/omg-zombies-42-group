...
public class TestHuman {
        ...
        public void testEncounterCharacter() {
                ...
                assertEquals(0, ((Character) f.getCharacterAt(1, 0)).getHealthPoints());
                ...
                h1.encounterCharacter(w, f);
                assertEquals(0, ((Character) f.getCharacterAt(1, 0)).getHealthPoints());
                f.clearCharacter(new Location(1, 0));
                ...
                f.place(mz, new Location(1, 0));
                f1.placeItem(new LiquidNitrogen(), 0, 0);
                h1.pickUpObject(f1, new Location(0, 0));
                h1.encounterCharacter(mz, f);
                assertEquals(0, ((Character) f.getCharacterAt(1, 0)).getHealthPoints());
                f.clearCharacter(new Location(1, 0));
                ...
                // Test de l'utilisation des edible ( debut de encounter
                // character
                ...
                h1.pickUpObject(f1, new Location(0, 0));
                h1.encounterCharacter(w, f);
                assertEquals(h1.getClass(), f.getCharacterAt(1, 0).getClass());
                ...
                assertEquals(h1.getClass(), f.getCharacterAt(1, 0).getClass());
                // Test de la suppression de l'inventaire d'un miscellaneous qui
                // n'a plus d'utilisation
        ...
        public void testEndOfTurn() {
                ...
                h1.endOfTurn(f);
                assertTrue(((Werewolf) f.getCharacterAt(0, 0)).isWerewolf());
        }
        ...
        public void testBaby() {
                ...
                if (res) {
                        assertTrue(((Human) f.getCharacterAt(1, 0)).isHuman());
                } else {
                        assertTrue(f.getCharacterAt(1, 0) == null);
                }
