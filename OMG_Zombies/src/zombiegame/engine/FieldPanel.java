...
public class FieldPanel extends JPanel {
        ...
        public void paintComponent(Graphics g) {
                ...
                g.drawImage(imgMap, widthBox, heightBox, field.getWidth() * widthBox, field
                                .getDepth()
                                * heightBox, null);

                for (int i = 0; i < field.getDepth(); i++) {
                        // dessin ligne
                        g.drawLine(widthBox, (i + 1) * heightBox,
                                        (field.getWidth() + 1) * widthBox, (i + 1) * heightBox);
                        for (int j = 0; j < field.getWidth(); j++) {
                                // dessin colonne
                                g.drawLine((j + 1) * widthBox, heightBox, (j + 1) * widthBox,
                                                (field.getDepth() + 1) * heightBox);
                                if (field.getObjectAt(i, j) != null) {
                                        ...
                                        if (o.isHuman()) {
                                                ...
                                                g.drawImage(imgWerewolf, (j + 1) * (widthBox),
                                                                (i + 1) * heightBox, widthBox,
                                                                heightBox, null);
                                        } else if (o.isVampire()) {
                                                g.drawImage(imgVampire, (j + 1) * (widthBox),
                                                                (i + 1) * heightBox, widthBox,
                                                                heightBox, null);
                                        } else if (o.isZombie()) {
                                         ...
                                         * g.fillRect((j + 1) * (widthBox), (i +
                                         * 1) * heightBox, widthBox, heightBox);
                                         */
                                }
                        }
                }

                g.drawString("Human : " + field.getNbHuman() + " Vampire : " + field.getNbVampire()
                                + " Zombie " + field.getNbZombie() + " Werewolf "
                                + field.getNbWerewolf(), widthBox, this.getHeight()
                                - (heightBox / 2));
